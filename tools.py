...
import re, random, string, ipaddress
...
def generate_ipv6_list(base_ip, num, step=1):
    '''
    生成IPv6地址列表
    '''
    start_ip = ipaddress.IPv6Address(base_ip)
    return [str(start_ip + i) for i in range(num)]
